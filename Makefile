...
cyc_movielens_hog_comp:
	@rm -rf movielens_completion_hog
	@g++ -Ofast -std=c++11 cyclades_movielens_completion.cpp -lnuma -lpthread -DHOG=1 -DN_EPOCHS=$(N_EPOCHS) -DTIME_LIMIT=$(TIME_LIMIT) -DNTHREAD=$(NTHREAD) -o movielens_completion_hog
cyc_movielens_cyc_comp:
	@rm -rf movielens_completion_cyc
	@g++ -Ofast -std=c++11 cyclades_movielens_completion.cpp -lnuma -lpthread -DCYC=1 -DN_EPOCHS=$(N_EPOCHS) -DTIME_LIMIT=$(TIME_LIMIT) -DNTHREAD=$(NTHREAD) -o movielens_completion_cyc
